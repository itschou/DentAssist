                        ...
                        @else
                            <li>
                                <a href="{{ $paginator->previousPageUrl() }}" rel="prev"
                                    class="relative inline-flex items-center px-2 py-2 text-sm font-medium text-blue-500 bg-white border border-gray-300 rounded-l-md leading-5 hover:text-blue-700 focus:z-10 focus:outline-none focus:ring ring-blue-300 focus:border-blue-300 active:bg-gray-100 active:text-blue-700 transition ease-in-out duration-150"
                                ...
                                @foreach ($element as $page => $url)
                                    @if ($page == $paginator->currentPage())
                                        <li aria-current="page">
                                            <span
                                                class="relative inline-flex items-center px-4 py-2 -ml-px text-sm font-medium text-blue-500 bg-white border border-gray-300 cursor-default leading-5">{{ $page }}</span>
                                        </li>
                                    @else
                                        <li>
                                            <a href="{{ $url }}"
